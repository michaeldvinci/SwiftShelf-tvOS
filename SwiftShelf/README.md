...
- **Integrated Media Player**  
  Stream multi-track or single-file audiobooks directly from Audiobookshelf with an AVQueue-backed player. Playback resumes from your last position, syncs progress back to the server, exposes chapter skip controls, supports configurable speeds, and offers a sleep timer plus remote-command integration.
  ![Playback Controls](TODO: Screenshot showing the full-screen playback banner with track controls, progress scrubber, and sleep timer.)
...
- **Compact Mini Player**  
  ...
  ![Mini Player](TODO: Screenshot showing the compact player with cover art, progress bar, and transport controls.)
